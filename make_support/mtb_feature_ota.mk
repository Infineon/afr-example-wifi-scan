...
CY_OUTPUT_FILE_PATH=$(CY_BUILD_LOCATION)/afr-example-wifi-scan/$(TARGET)/$(CONFIG)
...
ifneq ($(CY_TFM_PSA_SUPPORTED),1)
POSTBUILD+=$(CY_AFR_SIGN_SCRIPT_FILE_PATH) $(CY_OUTPUT_FILE_PATH) afr-example-wifi-scan\
...
POSTBUILD+=$(CY_AFR_SIGN_SCRIPT_FILE_PATH) $(CY_OUTPUT_FILE_PATH) afr-example-wifi-scan $(CY_OBJ_COPY)\
	$(CY_AFR_MCUBOOT_SCRIPT_FILE_DIR) $(IMGTOOL_SCRIPT_NAME) $(IMGTOOL_COMMAND_ARG) $(CY_FLASH_ERASE_VALUE) $(MCUBOOT_HEADER_SIZE)\
